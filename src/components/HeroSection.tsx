      ...
      <div className="container max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            <h1 data-text="Imagination Traveler GPT" className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-glow text-white text-3d">
              ...
              >
                ...
                <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-40 h-64">
                  <div className="relative w-full h-full">
                    <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-28 h-48 bg-black rounded-t-full"></div>
                    <div className="absolute bottom-36 left-1/2 transform -translate-x-1/2 w-20 h-20 bg-space-300 rounded-full"></div>
                    <div className="absolute bottom-36 left-1/2 transform -translate-x-1/2 w-20 h-10 bg-black rounded-t-full"></div>
                    <div className="absolute bottom-24 left-1/2 transform -translate-x-1/2 rotate-45 w-16 h-6 bg-neon-cyan/30 filter blur-sm"></div>
                  </div>
                </div>
              </div>
              
              {/* Quote Bubble */}
              <div className="absolute -bottom-16 right-0 md:right-8 max-w-xs glass-panel rounded-lg p-4 animate-float">
